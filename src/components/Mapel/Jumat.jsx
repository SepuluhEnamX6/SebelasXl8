	...
	return (
		<>
			<div
				...
				<div className="w-[50%] text-base  font-medium">Pejasorkes</div>
				<div className="flex justify-center items-center text-sm">07.30-09.00</div>
			</div>
			<div
				className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60"
				data-aos="fade-up"
				data-aos-duration="600">
				<div className="w-[50%] text-base  font-medium">Bhasa iggris</div>
			...
			<div
				...
				<div className="flex justify-center items-center text-sm">09.30-10.00</div>
			</div>
			<div
